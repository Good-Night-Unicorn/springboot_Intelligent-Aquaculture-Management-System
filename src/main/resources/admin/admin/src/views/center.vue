<template>
	<div :style='{"padding":"20px 30px","fontSize":"15px"}'>
		<el-form
			:style='{"alignContent":"flex-start","padding":"0 180px 0 0","borderColor":"#eee","margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","borderWidth":"0px 0 0","display":"flex","width":"1080px","borderStyle":"solid"}'
		...
		>
				...
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'   v-if="flag=='yonghu'"  label="密保问题" prop="pquestion">
					<el-input v-model="ruleForm.pquestion"  placeholder="密保问题" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'   v-if="flag=='yonghu'"  label="密保答案" prop="panswer">
				...
				<el-form-item :style='{"padding":"0","margin":"20px 0 0"}'>
					<el-button class="btn3" :style='{"border":"0px solid #ccc","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"4px","background":"#49AACE","width":"auto","fontSize":"16px","minWidth":"110px","height":"40px"}' type="primary" @click="onUpdateHandler">
