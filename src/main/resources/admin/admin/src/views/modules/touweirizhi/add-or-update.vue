	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="投喂量" prop="shuliang" >
					<el-input v-model.number="ruleForm.shuliang" placeholder="投喂量" clearable  :readonly="ro.shuliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="投喂量" prop="shuliang" >
					<el-input v-model="ruleForm.shuliang" placeholder="投喂量" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="date" v-if="type!='info'" label="投喂时间" prop="touweishijian" >
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.touweishijian" 
						type="datetime"
						:readonly="ro.touweishijian"
						placeholder="投喂时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.touweishijian" label="投喂时间" prop="touweishijian" >
					<el-input v-model="ruleForm.touweishijian" placeholder="投喂时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="投喂说明" prop="touweishuoming" >
					<el-input v-model="ruleForm.touweishuoming" placeholder="投喂说明" clearable  :readonly="ro.touweishuoming"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="投喂说明" prop="touweishuoming" >
					<el-input v-model="ruleForm.touweishuoming" placeholder="投喂说明" readonly></el-input>
				</el-form-item>
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `touweirizhi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.touweirizhiCrossAddOrUpdateFlag = false;
											this.parent.search();
