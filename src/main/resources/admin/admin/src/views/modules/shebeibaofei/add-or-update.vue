	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="报废原因" prop="baofeiyuanyin" >
					<el-input v-model="ruleForm.baofeiyuanyin" placeholder="报废原因" clearable  :readonly="ro.baofeiyuanyin"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="报废原因" prop="baofeiyuanyin" >
					<el-input v-model="ruleForm.baofeiyuanyin" placeholder="报废原因" readonly></el-input>
				</el-form-item>
			</template>
