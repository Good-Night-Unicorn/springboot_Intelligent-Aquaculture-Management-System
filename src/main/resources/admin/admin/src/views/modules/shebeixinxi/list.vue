<template>
	<div class="main-content" :style='{"padding":"20px 30px","fontSize":"15px"}'>
			...
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"#fff","display":"flex"}' >
					<div :style='{"width":"30%","margin":"0 10px 0 0","alignItems":"center","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","alignItems":"center","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">设备名称</label>
						<el-input v-model="searchForm.shebeimingcheng" placeholder="设备名称" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"width":"30%","margin":"0 10px 0 0","alignItems":"center","display":"flex"}' class="select" label="设备类型" prop="shebeileixing">
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","alignItems":"center","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">设备类型</label>
				...
				<el-row class="actions" :style='{"padding":"10px","margin":"20px 0","flexWrap":"wrap","background":"none","display":"flex"}'>
					...
					<el-button class="btn18" v-if="isAuth('shebeixinxi','设备库存统计')" type="success" @click="chartDialog1()">
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('shebeixinxi','设备采购')" @click="shebeicaigouCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								设备采购
							</el-button>
							<el-button class="btn8" v-if="isAuth('shebeixinxi','设备报修')" @click="shebeibaoxiuCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								设备报修
							</el-button>
							<el-button class="btn8" v-if="isAuth('shebeixinxi','设备报废')" @click="shebeibaofeiCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								设备报废
							</el-button>
							<el-button class="btn8" v-if="isAuth('shebeixinxi','巡检计划')" @click="xunjianjihuaCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								巡检计划
							</el-button>
		...
		<shebeicaigou-cross-add-or-update v-if="shebeicaigouCrossAddOrUpdateFlag" :parent="this" ref="shebeicaigouCrossaddOrUpdate"></shebeicaigou-cross-add-or-update>
		...
		<shebeibaofei-cross-add-or-update v-if="shebeibaofeiCrossAddOrUpdateFlag" :parent="this" ref="shebeibaofeiCrossaddOrUpdate"></shebeibaofei-cross-add-or-update>
		<xunjianjihua-cross-add-or-update v-if="xunjianjihuaCrossAddOrUpdateFlag" :parent="this" ref="xunjianjihuaCrossaddOrUpdate"></xunjianjihua-cross-add-or-update>
...
<script>
	...
	import shebeicaigouCrossAddOrUpdate from "../shebeicaigou/add-or-update";
	import shebeibaoxiuCrossAddOrUpdate from "../shebeibaoxiu/add-or-update";
	import shebeibaofeiCrossAddOrUpdate from "../shebeibaofei/add-or-update";
	import xunjianjihuaCrossAddOrUpdate from "../xunjianjihua/add-or-update";
	import {
		Loading
	} from 'element-ui';
	export default {
		data() {
			return {
				...
				shebeicaigouCrossAddOrUpdateFlag: false,
				shebeibaoxiuCrossAddOrUpdateFlag: false,
				shebeibaofeiCrossAddOrUpdateFlag: false,
				xunjianjihuaCrossAddOrUpdateFlag: false,
		...
		components: {
			AddOrUpdate,
			shebeicaigouCrossAddOrUpdate,
			shebeibaoxiuCrossAddOrUpdate,
			shebeibaofeiCrossAddOrUpdate,
			xunjianjihuaCrossAddOrUpdate,
		},
		methods: {
			imgPreView(url){
				this.previewImg = url
			...
			shebeicaigouCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.shebeicaigouCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.shebeicaigouCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.shebeicaigouCrossaddOrUpdate.init(row.id,type);
				});
			},
			shebeibaoxiuCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.shebeibaoxiuCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
			...
			shebeibaofeiCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.shebeibaofeiCrossAddOrUpdateFlag = true;
				this.$storage.set('crossObj',row);
				this.$storage.set('crossTable','shebeixinxi');
				this.$storage.set('statusColumnName',statusColumnName);
				this.$storage.set('statusColumnValue',statusColumnValue);
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.shebeibaofeiCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.shebeibaofeiCrossaddOrUpdate.init(row.id,type);
				});
			},
			xunjianjihuaCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.xunjianjihuaCrossAddOrUpdateFlag = true;
				this.$storage.set('crossObj',row);
				this.$storage.set('crossTable','shebeixinxi');
				this.$storage.set('statusColumnName',statusColumnName);
				this.$storage.set('statusColumnValue',statusColumnValue);
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.xunjianjihuaCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.xunjianjihuaCrossaddOrUpdate.init(row.id,type);
				});
			},
