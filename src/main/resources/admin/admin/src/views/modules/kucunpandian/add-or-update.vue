	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="库存数" prop="shuliang" >
					<el-input v-model.number="ruleForm.shuliang" placeholder="库存数" clearable  :readonly="ro.shuliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="库存数" prop="shuliang" >
					<el-input v-model="ruleForm.shuliang" placeholder="库存数" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="盘点数" prop="pandianshu" >
					<el-input v-model.number="ruleForm.pandianshu" placeholder="盘点数" clearable  :readonly="ro.pandianshu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="盘点数" prop="pandianshu" >
					<el-input v-model="ruleForm.pandianshu" placeholder="盘点数" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="date" v-if="type!='info'" label="盘点时间" prop="pandianshijian" >
					<el-date-picker
				...
				<el-form-item class="input" v-else-if="ruleForm.pandianshijian" label="盘点时间" prop="pandianshijian" >
					<el-input v-model="ruleForm.pandianshijian" placeholder="盘点时间" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="盘点备注" prop="pandianbeizhu" >
					<el-input v-model="ruleForm.pandianbeizhu" placeholder="盘点备注" clearable  :readonly="ro.pandianbeizhu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="盘点备注" prop="pandianbeizhu" >
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `kucunpandian/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.kucunpandianCrossAddOrUpdateFlag = false;
											this.parent.search();
