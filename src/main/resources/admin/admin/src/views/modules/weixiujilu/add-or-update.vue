	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.weixiushijian" label="维修时间" prop="weixiushijian" >
			...
			<el-form-item v-else-if="ruleForm.weixiuqingkuang" label="维修情况" prop="weixiuqingkuang" >
				<span class="text">{{ruleForm.weixiuqingkuang}}</span>
			</el-form-item>
