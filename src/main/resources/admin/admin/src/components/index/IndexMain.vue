<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 12%","margin":"0","position":"relative","background":"linear-gradient(180deg, #4AC6F4 0%, #D0F2FF 22%, #FFFFFF 100%)","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"none","padding":"0 20px 0","alignItems":"center","color":"#fff","display":"flex","justifyContent":"flex-end","top":"0","left":"40px","background":"none","width":"calc(100% - 40px)","fontSize":"16px","position":"relative","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"14px 40px","margin":"0px auto 0 40px","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"#0B7AA450","width":"calc(100% - 40px)","fontSize":"16px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
