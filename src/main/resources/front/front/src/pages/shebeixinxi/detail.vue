<template>
	...
	<!--  -->
		...
		<div class="detail-preview">
				...
				<div class="info">
					...
					<div class="btn_box">
						...
						<el-button class="reserveBtn" 
							v-if="btnAuth('shebeixinxi','设备采购')" 
							@click="onAcross('shebeicaigou','','','','')" type="warning">
							设备采购
						</el-button>
						<el-button class="reserveBtn" 
							v-if="btnAuth('shebeixinxi','设备报修')" 
							@click="onAcross('shebeibaoxiu','','','','')" type="warning">
							设备报修
						</el-button>
						<el-button class="reserveBtn" 
							v-if="btnAuth('shebeixinxi','设备报废')" 
							@click="onAcross('shebeibaofei','','','','')" type="warning">
							设备报废
						</el-button>
						<el-button class="reserveBtn" 
							v-if="btnAuth('shebeixinxi','巡检计划')" 
							@click="onAcross('xunjianjihua','','','','')" type="warning">
							巡检计划
						</el-button>
					</div>
				</div>
			...
			<div class="detail2">
				<div class="desc-view">
					<div class="desc-label">设备描述</div>
				</div>
				<div class="desc-text ql-snow ql-editor" v-html="detail.shebeimiaoshu"></div>
			</div>
